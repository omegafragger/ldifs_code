...
class RESISC45:
    def __init__(self,
        ...
        self.train_dataset = RESISC45Dataset(root=location, split='train', transforms=preprocess, target_transform=self.target_transform)
        ...
        self.test_dataset = RESISC45Dataset(root=location, split='test', transforms=preprocess, target_transform=self.target_transform)
